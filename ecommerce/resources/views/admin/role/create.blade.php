                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="phone" class="form-control" value="{{old('phone')}}" placeholder="User phone">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="product_name">User Password</label>
                                        <input type="password" name="password" class="form-control" value="{{old('password')}}" placeholder="User password">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <h6>Brand</h6>
                                        <input type="checkbox" name="brand" value="1" checked>
                                    </div>
                                    <div class="col-md-3">
                                        <h6>Product</h6>
